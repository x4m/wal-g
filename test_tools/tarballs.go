...
func (fileTarBall *FileTarBall) SetUp(crypter internal.Crypter, names ...string) {
	if fileTarBall.tarWriter == nil {
		...
		if crypter.IsUsed() {
			...
			fileTarBall.writeCloser = &internal.CascadeWriteCloser{
...
func (fileTarBall *FileTarBall) Finish(sentinelDto *internal.BackupSentinelDto) error {
...
func (n *NOPTarBall) SetUp(crypter internal.Crypter, params ...string) {}
func (n *NOPTarBall) CloseTar() error                              { return nil }
func (n *NOPTarBall) Finish(sentinelDto *internal.BackupSentinelDto) error {
